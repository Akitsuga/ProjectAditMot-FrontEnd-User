...
class ManageProduct extends Component {
    ...
    getProduct = () => {
        axios.get('http://localhost:1985/products')
            .then(res => {
    ...
    addProduct = () => {
        ...
        axios.post('http://localhost:1985/products',{
            name: nama,
            desc: desk,
            price: harga,
            src:sumber
    ...
    deleteProduct = (id) => {
        axios.delete('http://localhost:1985/products/' + id)
        .then(() => {
            this.getProduct()
        })
    }
    ...
    onSaveItem = (id) => {
        ...
        axios.put('http://localhost:1985/products/' + id, {
            name: nama,
            desc: desk,
            price: harga,
            src:sumber
